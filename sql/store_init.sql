...
CREATE TABLE `product_descript_1` (
                                      ...
                                      PRIMARY KEY (`id`) USING BTREE,
                                      INDEX `idx_product_info_id`(`product_info_id`) USING BTREE
...
CREATE TABLE `product_info_1` (
                                  ...
                                  INDEX `idx_store_info_id`(`store_info_id`) USING BTREE
